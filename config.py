...
# مده الاغنيه بتبقي ٦٠ دقيقه انا مخليها 120 تقدر تزودها
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002035680675")
...
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5554836675] + []
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Hossamhos/hoss456",
)
#متغيرهاش نهائي
...
CHANNEL = getenv(
    "CHANNEL", "SOU_LOFFY_RCE"
)  # قناه الاشتراك الاجباري مثل هيك https://t.me/SOU_LOFFY_RCE
CHANNEL_SUDO = getenv(
    "CHANNEL_SUDO", "https://t.me/SOU_LOFFY_RCE"
)  # قناة السورس هيك https://t.me/SOU_LOFFY_RCE
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/SOU_LOFFY_RCE"
)  #جروب السورس https://t.me/BarGohara
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/alamaalhlwa"
) 
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/H_OS_S_AM")
...
# صوره الاستارت
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/3a7d6cd84a83d0956d3f6.jpg")
